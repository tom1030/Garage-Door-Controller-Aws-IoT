...
const ShadowConnectParameters_t ShadowConnectParametersDefault = {(char *) AWS_IOT_GDC_THING_NAME,
...
void aws_iot_shadow_enable_discard_not_my_delta_msgs(void) {
	shadowDiscardNotMyDeltaFlag = true;
}

void aws_iot_shadow_disable_discard_not_my_delta_msgs(void) {
	shadowDiscardNotMyDeltaFlag = false;
}
...
IoT_Error_t aws_iot_shadow_init(AWS_IoT_Client *pClient, ShadowInitParameters_t *pParams) {
	...
	mqttInitParams.mqttPacketTimeout_ms = 2000;
