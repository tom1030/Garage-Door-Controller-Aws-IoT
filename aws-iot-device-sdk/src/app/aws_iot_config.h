...
// Get from console
// =================================================
#define AWS_IOT_MQTT_HOST              "a3fk1eap1q6mdl.iot.ap-southeast-1.amazonaws.com"//"a3fk1eap1q6mdl.iot.us-east-1.amazonaws.com"// ///< Customer specific MQTT HOST. The same will be used for Thing Shadow
#define AWS_IOT_MQTT_PORT              8883 ///< default port for MQTT/S
#define AWS_IOT_MQTT_CLIENT_ID         "GDC_FFFFFF" ///< MQTT client ID should be unique for every device
#define AWS_IOT_GDC_THING_NAME 		   "GarageDoorController"//"GarageDoorTest"// ///< Thing Name of the Shadow this device is associated with
#define AWS_IOT_OTA_THING_NAME 		   "firmware_ota" ///< Thing Name of the Shadow this device is associated with
...
//define macro by tom.zhang
//#define _ENABLE_THREAD_SUPPORT_   //Not use thread Mutex.
#define ENABLE_IOT_DEBUG     //log print
